...
//	}
//	// 直接使用指针类型，无需类型断言
//	limitPtr := clause.Limit
//	offsetPtr := clause.Offset
//	// 处理 LIMIT
//	limit := 0
//	if limitPtr != nil {
//		limit = *limitPtr
...
////		if err := m.Config.DB.AutoMigrate(value); err != nil {
////			return err
////		}
////
////		// 获取表名
////		modelValue := m.Config.DB.ValueOf(value)
////		if modelValue.Kind() == reflect.Ptr {
////			modelValue = modelValue.Elem()
////		}
////
////		tableName := m.Config.DB.NamingStrategy.TableName(modelValue.Type().Name())
////
////		// 添加表空间选项
////		if err := m.Config.DB.Exec(fmt.Sprintf("ALTER TABLE \"%s\" STORAGE(ON PRIMARY)", tableName)).Error; err != nil {
////			return err
////		}
////	}
////	return nil
